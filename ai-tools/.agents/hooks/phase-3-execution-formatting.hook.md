...
5. Execute linting and formatting:
   - `npm run lint`
   - `npm run format`
6. Generate a draft report using report templates from `.agents/report-templates/`.
...
To optimize code quality and provide context-aware help, GitHub Copilot leverages knowledge files under `.agents/knowledge/` and workflow skill files under `.agents/skills/`.
...
| :--------------------- | :------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Bug Fix**            | `skills/bug-fix/SKILL.md`                    | `knowledge/core-engineering-guidelines.md`                                                                                                                                                             | `report-templates/bug-report.md`<br>**Report**: `BUG-REPORT-[TICKET-ID]-[DATE]-[TIME].ctx.md` → `.agents/reports/`                                                             |
| **Feature Delivery**   | `skills/feature-delivery/SKILL.md`           | `knowledge/core-engineering-guidelines.md`<br>`skills/angular-architecture/SKILL.md`<br>`skills/styling-standards/SKILL.md`                                                                            | `report-templates/technical-design.md` (planning)<br>`report-templates/engineering-report.md` (final)<br>`report-templates/pull-request.md` (PR)<br>**Report**: `ENGINEERING-REPORT-[FEATURE-NAME]-[DATE]-[TIME].ctx.md` → `.agents/reports/` |
| **Refactor**           | `skills/refactor/SKILL.md`                   | `knowledge/core-engineering-guidelines.md`<br>`skills/angular-architecture/SKILL.md`<br>`skills/styling-standards/SKILL.md`                                                                            | `report-templates/technical-design.md`<br>`report-templates/engineering-report.md`<br>**Report**: `REFACTOR-REPORT-[COMPONENT-NAME]-[DATE]-[TIME].ctx.md` → `.agents/reports/` |
| **Unit Test**          | `skills/unit-test/SKILL.md`                  | `knowledge/core-engineering-guidelines.md`<br>`skills/angular-architecture/SKILL.md`                                                                                                                   | `report-templates/engineering-report.md`<br>**Report**: `TEST-REPORT-[COMPONENT-NAME]-[DATE]-[TIME].ctx.md` → `.agents/reports/`                                                |
| **Code Review**        | `skills/code-review/SKILL.md`                | `knowledge/core-engineering-guidelines.md`                                                                                                                                                             | `report-templates/pull-request.md`<br>**Report**: `CODE-REVIEW-[PR-ID]-[DATE]-[TIME].ctx.md` → `.agents/reports/`                                                              |
| **Jira Ticket Review** | `skills/jira-ticket-review/SKILL.md`         | `knowledge/core-engineering-guidelines.md`                                                                                                                                                             | `report-templates/jira-ticket-review.md`<br>**Report**: `JIRA-REVIEW-[TICKET-ID]-[DATE]-[TIME].ctx.md` → `.agents/reports/`                                                     |
