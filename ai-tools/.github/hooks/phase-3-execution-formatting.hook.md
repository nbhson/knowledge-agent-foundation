...
| **Unit Test**          | `skills/unit-test/SKILL.md`                  | `knowledge/core-engineering-guidelines.md`<br>`skills/angular-architecture/SKILL.md`                                                                                                                   | `report-templates/engineering-report.md`<br>**Report**: `TEST-REPORT-[COMPONENT-NAME]-[DATE]-[TIME].ctx.md` → `.github/reports/`                                                |
| **Code Review**        | `skills/code-review/SKILL.md`                | `knowledge/core-engineering-guidelines.md`                                                                                                                                                             | `report-templates/pull-request.md`<br>**Report**: `CODE-REVIEW-[PR-ID]-[DATE]-[TIME].ctx.md` → `.github/reports/`                                                              |
