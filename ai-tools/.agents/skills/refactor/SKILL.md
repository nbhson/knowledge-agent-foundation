...
2. **Plan & Get Approval**: Detail the refactoring changes in `implementation_plan.md` using the Technical Design template (`.agents/report-templates/technical-design.md`). Obtain explicit developer confirmation before executing code changes if the task is non-trivial.
...
6. **Validation & Report**:
   ...
   - Generate/finalize report artifacts through the [Report Generation Skill](../report-generation/SKILL.md) and Phase 4 (`.agents/hooks/phase-4-validation-pr.hook.md`).
