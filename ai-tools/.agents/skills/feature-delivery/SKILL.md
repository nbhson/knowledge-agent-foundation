...
2. **Plan & Get Approval**: Write an implementation plan in `implementation_plan.md` using the Technical Design template (`.agents/report-templates/technical-design.md`). Wait for developer approval before coding if the task is non-trivial.
...
8. **Report & Submit**:
   ...
   - Finalize validation and PR readiness via Phase 4 (`.agents/hooks/phase-4-validation-pr.hook.md`).
