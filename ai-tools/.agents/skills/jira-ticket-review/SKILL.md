...
5. **Report**:
   - Complete the `jira-ticket-review.md` template from `/.agents/report-templates/`.
   - Save the report to `.agents/reports/` with the naming convention: `JIRA-REVIEW-[TICKET-ID]-[DATE]-[TIME].ctx.md`.
