...
6. **Finalize Report**:
   - Complete and review the generated report file in `.agents/reports/`.
...
7. **Submit PR**:
   ...
   - Propose opening a Pull Request. Fill out the description using the Pull Request template (`.agents/report-templates/pull-request.md`).

---

## Templates Reference

- **Pull Request Template**: `/.agents/report-templates/pull-request.md`
- **Engineering Report**: `/.agents/report-templates/engineering-report.md` (for non-bug workflows)
- **Bug Report**: `/.agents/report-templates/bug-report.md` (for bug fix workflows)
- **Jira Ticket Review**: `/.agents/report-templates/jira-ticket-review.md` (for ticket review workflows)
