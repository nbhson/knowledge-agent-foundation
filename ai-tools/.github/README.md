# .github — AI-Assisted Engineering Framework
...
- Run `scripts/validate-links.sh` to verify every file path referenced across this framework still exists (prevents broken links like typos in `.github/...` paths).
